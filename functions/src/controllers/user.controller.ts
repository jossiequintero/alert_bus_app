    ...
    if (stopLat && stopLon) {
      ...
      for (const busDoc of busesQuery.docs) {
        ...
        if (busLocation && busLocation.latitude && busLocation.longitude) {
          ...
          // Si el bus está dentro del radio de proximidad del usuario, notificar inmediatamente
